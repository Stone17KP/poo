...
public class Main {
	...
	public static void main(String[] args) {
		...
		LinkedList<Estadio> Estadios = new LinkedList<Estadio>();
				...
				Estadios.add(Estadio_0);
				Estadios.add(Estadio_1);
				Estadios.add(Estadio_2);
				Estadios.add(Estadio_3);
				Estadios.add(Estadio_4);
				Estadios.add(Estadio_5);
				Estadios.add(Estadio_6);
				Estadios.add(Estadio_7);
	...
	/*public static Estadio  EstadiosRandom(Encargado pacho) {
